...
[string]$Global:dp_series_publisher = ''             #? Publisher de la serie
[string]$Global:dp_series_year = ''                  #? Año del volumen de la serie

[int]$Global:dp_comic_issue = ''                     #? Numero del comic en la serie ( obtenido del nombre del comic ) 
[string]$Global:dp_comic_fullname = ''               #? Ruta completa del comic ( incluido directorio, nombre y la extension )
...
[string]$Global:dp_comic_year = ''                   #? Año obtenido a traves del nombre del comic.
...
[string]$Global:dp_ocr_year = ''                     #? Año extraido mediante OCR de las imagenes
[string]$Global:dp_ocr_publisher = ''                #? Publisher extraido mediante OCR de las imagenes
